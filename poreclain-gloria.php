<?php
    $title ='بورسلين جلوريا';
    $style_name ="layout/css/poreclain/poreclain-gloria.css";
    include "init.php";

?>

<section class="poreclain_gloria">
    <div class="header">
        <img src="layout/images/poreclain/gloria/gloria-header.jpg" alt="Por gloria">
        <h3>بورسلين جلوريا</h3>
    </div>
    <div class="container">
        <div class="type container">
            <h3 class="text-right">بورسلين / محلي / جلوريا</h3>
            <p class="text-right"> <img src="layout/images/poreclain/gloria/made-in-egypt-1.png"> &nbsp;&nbsp;&nbsp; صنع في مصر</p>
        </div>
        <div class="row">
            <div class="col-md-2">
                <div class="insta">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="all-products">
                            ...
                            <img src="<?php echo 'layout/images/poreclain/gloria/' . $rows['Image']; ?> "  alt="<?php echo "poreclain gloria" . $rows['Image']; ?>">
                        </div>
                    </div>
