<?php
    $title ='بورسلين مستورد';
    $style_name ="layout/css/poreclain/poreclain-imported.css";
    include "init.php";

?>

<section class="poreclain_imported">
    <div class="header">
        <img src="layout/images/poreclain/imported/imported-header.jpg" alt="Por Imported">
        <h3>بورسلين مستورد</h3>
    </div>
    <div class="container">
        <div class="type container">
            <h3 class="text-right">بورسلين / مستورد</h3>
            <p class="text-right"> <img src="layout/images/poreclain/imported//india.png"> &nbsp;&nbsp;&nbsp; صنع في الهند</p>
            <p class="text-right"> <img src="layout/images/poreclain//imported/china.jpg"> &nbsp;&nbsp;&nbsp; صنع في الصين</p>
            <p class="text-right"> <img src="layout/images/poreclain//imported/emarat.png"> &nbsp;&nbsp;&nbsp; صنع في الامارات</p>
        </div>
        <div class="row">
            <div class="col-md-2">
                <div class="insta">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="all-products">
                            ...
                            <img src="<?php echo 'layout/images/poreclain/imported/' . $rows['Image']; ?> "  alt="<?php echo "poreclain imported" . $rows['Image']; ?>">
                        </div>
                    </div>
